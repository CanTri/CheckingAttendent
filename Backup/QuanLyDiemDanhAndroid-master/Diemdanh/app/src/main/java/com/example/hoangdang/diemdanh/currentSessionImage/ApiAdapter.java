...
public class ApiAdapter {
    ...
    public void UpdateLog(Context context, final String log,final String name,final VolleyCallBack callBack)
    {
        ...
        String url = "http://tunghiepandroid.pe.hu/LogAPI/updateLog.php";
    ...
    public void TestImg(final Bitmap myimage,Context context,final VolleyCallBack callBack)
    {
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(context);
        String url = "http://tunghiepandroid.pe.hu/UploadAPI/imgur.php";
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
    ...
    {
        RequestQueue requestQueue = Volley.newRequestQueue(context);
        String url = "http://tunghiepandroid.pe.hu/UploadAPI/getimageapi.php";
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
    ...
    {
        RequestQueue requestQueue = Volley.newRequestQueue(context);
        String url = "http://tunghiepandroid.pe.hu/UploadAPI/updateimageapi.php";
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                try {
    ...
    public void CheckMyApi(final Bitmap myimage,final String gallery_name,Context context,final VolleyCallBack callBack)
    {
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(context);
        String url = "http://tunghiepandroid.pe.hu/Kairos/recognize.php";
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                Log.wtf("HiepAPI",response);
